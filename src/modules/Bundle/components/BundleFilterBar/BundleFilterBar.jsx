...
const availableFilters = ['Fixed', 'Flexible', 'Seasonal', 'Sports', 'Entertainment', 'Premium', 'Basic', 'Active', 'Expired'];

const BundleFilterBar = ({ activeFilters, onRemoveFilter, onAddFilter }) => {
  ...
  return (
    <div style={styles.root} role="toolbar" aria-label="Bundle filters">
...
export default BundleFilterBar;
