...
const availableFilters = ['Active', 'Suspended', 'Churned', 'VIP', 'Premium', 'Standard', 'North America', 'Europe', 'Asia Pacific'];

const CustomerFilterBar = ({ activeFilters, onRemoveFilter, onAddFilter }) => {
  ...
  return (
    <div style={styles.root} role="toolbar" aria-label="Customer filters">
