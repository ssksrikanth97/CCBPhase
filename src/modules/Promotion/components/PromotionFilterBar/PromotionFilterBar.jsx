...
const availableFilters = ['Discount', 'Free Trial', 'Cashback', 'Referral', 'Seasonal', 'Evergreen', 'Active', 'Scheduled', 'Expired', 'All Users', 'New Users', 'Existing Users'];

const PromotionFilterBar = ({ activeFilters, onRemoveFilter, onAddFilter }) => {
  ...
  return (
    <div style={styles.root} role="toolbar" aria-label="Promotion filters">
