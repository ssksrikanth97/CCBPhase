...
const availableFilters = ['Open', 'In-Progress', 'Resolved', 'Critical', 'High', 'Medium', 'Billing', 'Technical', 'Account'];

const TicketFilterBar = ({ activeFilters, onRemoveFilter, onAddFilter }) => {
  ...
  return (
    <div style={styles.root} role="toolbar" aria-label="Ticket filters">
